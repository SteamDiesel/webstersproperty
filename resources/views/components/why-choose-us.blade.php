<div class="min-h-screen flex justify-center items-center text-white py-24 px-4" style="background-color: #1e4975; background-image: url(images/BG-Meeting-Blue-2.webp); background-repeat: no-repeat; background-attachment: fixed; background-position: center; background-size: cover;">
